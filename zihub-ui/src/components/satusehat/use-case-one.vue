<template>
    <div class="flex-grow border-2 border-zihub-border  bg-zihub-background rounded-2xl p-8">
        ...
        <div v-if="isModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div class="bg-zihub-background p-8 rounded-lg shadow-lg w-1/2">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalPatientNik" class="table-filter-input mt-1 block w-full" />
                    </div>
                    <div>
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button class="bg-blue-500 text-white px-4 py-2 rounded-md">Save Data</button>
                    </div>
                </div>
            </div>
        </div>
